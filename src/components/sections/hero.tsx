...
const sliderContent = [
    {
        ...
        subtitle: "Welcome to MediDent Clinic",
        title: "We Use The Most Effective Technologies",
        description: "Our clinic is equipped with the latest dental technology to provide you with safe, efficient, and comfortable treatments.",
    },
    {
        image: PlaceHolderImages.find(p => p.id === 'hero-slider-2'),
        subtitle: "Your Smile, Our Priority",
        title: "Providing The Best Dental Care",
        description: "From routine check-ups to advanced cosmetic procedures, our dedicated team is here to ensure your oral health is at its best.",
    },
    {
        image: PlaceHolderImages.find(p => p.id === 'hero-slider-3'),
        subtitle: "Expert and Compassionate Team",
        title: "Your Smile is Our Passion",
        description: "We are a team of dental professionals who are passionate about creating beautiful, healthy smiles for our patients.",
    },
]
